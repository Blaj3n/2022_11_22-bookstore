...
class LendingController extends Controller
{
    ...
    //Az eddig kikölcsönzött könyvek listája a bejelentkezett felhasználó által (a users, a copies és a lendings tábla idevonatkozó adatai).
    public function userLendingsCopies()
    {
        $user = Auth::user();	//bejelentkezett felhasználó
        $lendings = Lending::with('user_c')->with('copy_c')->where('user_id','=', $user->id)->get();
        return $lendings;
    }
